...
## 1.6.0 release metadata

Version 1.6.0, build 12, is dated 2026-09-20. The app manifest, direct-package
...
tagging `v1.6.0`; publication still requires the signed and notarized workflow.
